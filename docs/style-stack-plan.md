...
source location — offered copy-only, with the matched sheet's entry file suggested. *Corrected
...
- `/var/www/dpace/staging/public/wp-content/plugins/d-pace` has **uncommitted work that is not
  ...
  commit there.
- 3.7.1 is tagged in the plugin header and none of 3.0.0 to 3.7.1 is **released**. The digitalis.ca update JSON is not
